...
class LoginViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.emailTextField.topAnchor.constraint(equalTo: self.titleLabel.bottomAnchor, constant: 40),
            ...
            self.loginButton.leadingAnchor.constraint(equalTo: self.contentView.leadingAnchor, constant: 20),
            self.loginButton.trailingAnchor.constraint(equalTo: self.contentView.trailingAnchor, constant: -20),
            self.loginButton.heightAnchor.constraint(equalToConstant: 50),

            self.registerButton.topAnchor.constraint(equalTo: self.loginButton.bottomAnchor, constant: 20),
            self.registerButton.centerXAnchor.constraint(equalTo: self.contentView.centerXAnchor),
